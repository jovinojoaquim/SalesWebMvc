...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Alisson", "alissonrodrigues@hotmail.com", new DateTime(1996, 12, 3), 3000.0, d2);

            SalesRecord sr1 = new SalesRecord(1, new DateTime(2019, 6, 20), 2000.0, SalesStatus.Billed, s1);
            SalesRecord sr2 = new SalesRecord(2, new DateTime(2019, 6, 20), 3000.0, SalesStatus.Billed, s2);
